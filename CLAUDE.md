...
## Key concepts
- **Areas** — user-defined categories (Finances, Health, Social, Job, Misc + custom). Each has a unique soft color. Long-press (600ms) on mobile to delete with confirmation.
...
- Mobile nav: bottom bar (This Week | + | Areas), Areas screen is a full-screen list of cards (same style as task cards)
